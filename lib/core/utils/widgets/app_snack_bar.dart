...
class CustomSnackBar extends StatelessWidget {
  ...
  const CustomSnackBar({super.key, required this.message, this.isSuccess = false});
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          //   height: 24,
          // ),
          Icon(isSuccess ? Icons.check : Icons.error, color: Colors.white, size: 24),
  ...
  static void showSuccess(BuildContext context, String message) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        elevation: 0,
        padding: const EdgeInsets.all(12),
        content: CustomSnackBar(message: message, isSuccess: true),
      ),
    );
  }
}
