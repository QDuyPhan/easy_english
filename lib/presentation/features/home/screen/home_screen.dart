...
class _HomeScreenState extends State<HomeScreen> {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<WordsBloc, WordsState>(
        builder: (context, state) {
          ...
          return _buildListWord(state.words, state);
        },
      ),
    );
  }

  Widget _buildListWord(List<String> words, WordsState state) {
  ...
  Widget _buildWordDetails(String word) {
    return Column(children: [Text(word)]);
  }
}
