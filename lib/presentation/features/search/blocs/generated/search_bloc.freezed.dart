...
/// @nodoc
class __$$SearchWordsImplCopyWithImpl<$Res>
...
class _$SearchWordsImpl implements _SearchWords {
  const _$SearchWordsImpl({required this.query});
  ...
  @override
  String toString() {
    return 'SearchEvent.searchWords(query: $query)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SearchWordsImplCopyWith<_$SearchWordsImpl> get copyWith =>
      __$$SearchWordsImplCopyWithImpl<_$SearchWordsImpl>(this, _$identity);
...
abstract class _SearchWords implements SearchEvent {
  const factory _SearchWords({required final String query}) = _$SearchWordsImpl;
...
class _$SuccessImpl implements _Success {
  ...
  @override
  String toString() {
    return 'SearchState.success(results: $results)';
  }
...
abstract class _Success implements SearchState {
  const factory _Success({required final List<WordEntity> results}) =
      _$SuccessImpl;
...
abstract class _NoResults implements SearchState {
