...
class TopicCategoryScreen extends StatefulWidget {
  ...
  const TopicCategoryScreen({super.key, required this.dictionary});
...
class _TopicCategoryScreenState extends State<TopicCategoryScreen> {
  ...
  void _assignUniqueColors() {
    ...
    _colors = List.generate(widget.dictionary.category.length, (index) {
      final available =
          availableColors
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: CustomAppBar(
        title: widget.dictionary.topic.toUpperCase(),
        leading: [
          IconButton(
