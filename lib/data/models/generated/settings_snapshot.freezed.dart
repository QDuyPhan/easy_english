...
abstract class $SettingsSnapshotCopyWith<$Res> {
  factory $SettingsSnapshotCopyWith(
    ...
    $Res Function(SettingsSnapshot) then,
...
class _$SettingsSnapshotCopyWithImpl<$Res, $Val extends SettingsSnapshot>
  ...
  @override
  $Res call({Object? seek = null, Object? themeMode = null}) {
    return _then(
      _value.copyWith(
            seek:
                null == seek
...
abstract class _$$SettingsSnapshotImplCopyWith<$Res>
    implements $SettingsSnapshotCopyWith<$Res> {
  factory _$$SettingsSnapshotImplCopyWith(
    _$SettingsSnapshotImpl value,
...
class __$$SettingsSnapshotImplCopyWithImpl<$Res>
  ...
  __$$SettingsSnapshotImplCopyWithImpl(
    _$SettingsSnapshotImpl _value,
...
class _$SettingsSnapshotImpl implements _SettingsSnapshot {
  const _$SettingsSnapshotImpl({this.seek = 0X2196F3, this.themeMode = 0});
  ...
  Map<String, dynamic> toJson() {
    return _$$SettingsSnapshotImplToJson(this);
  }
}

abstract class _SettingsSnapshot implements SettingsSnapshot {
  const factory _SettingsSnapshot({final int seek, final int themeMode}) =
      _$SettingsSnapshotImpl;
